...
def insert(bst, v):
    ...
    # if bst is BST.empty:
    #     bst = BST(v)
    # elif (bst.left is BST.empty or bst.left.max() <= v) and (bst.right is BST.empty or bst.right.min() > v):
    #     if bst.label <= v:
    #         left = BST(bst.label, bst.left, BST.empty)
    #         right = bst.right
    #     else:
    #         left = bst.left
    #         right = BST(bst.label, bst.empty, bst.right)
    #     bst.label = v
    #     bst.left = left
    #     bst.right = right
    # else:
    ...
    if v <= bst.label and bst.left is BST.empty:
        bst.left = BST(v)
        c = True
    if v > bst.label and bst.right is BST.empty:
        bst.right = BST(v)
        c = True
    if c:
        return
