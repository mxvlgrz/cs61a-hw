...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    def cal_next(score, opponent_score, strategy, dice):
    ...
    while score0<goal and score1<goal:
        if player == 0:
            score0, score1 = cal_next(score0, score1, strategy0, dice)
        elif player == 1:
            score1, score0 = cal_next(score1, score0, strategy1, dice)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            cur_score = score1
        if cur_score - previous_score > high:
            high = cur_score - previous_score
            print(high, "point(s)! That's the biggest gain yet for Player", who)
        return announce_highest(who, high, cur_score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(1, 11):
        ...
        i_average = averaged(i, dice)
        if i_average > max_result:
            max_result, result_i = i_average, i
    return result_i
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if ((free_bacon(opponent_score)+score < opponent_score) and (is_swap(free_bacon(opponent_score)+score, opponent_score))) else bacon_strategy(score, opponent_score, margin, num_rolls)
    # END PROBLEM 11
